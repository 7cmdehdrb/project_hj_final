...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        # Config files
        DeclareLaunchArgument('cfg',      default_value='~/.ros/rtabmap_custom.ini',      description='To change RTAB-Map\'s parameters, set the path of config file (*.ini) generated by the standalone app.'),
        # DeclareLaunchArgument('cfg',      default_value='~/.ros/rtabmap_default.ini',      description='To change RTAB-Map\'s parameters, set the path of config file (*.ini) generated by the standalone app.'),
        ...
        DeclareLaunchArgument('database_path',  default_value='~/ros2_ws/rtabmap.db',  description='Where is the map saved/loaded.'),
